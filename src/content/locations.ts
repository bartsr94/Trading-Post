...
export const LOCATIONS: LocationDef[] = [
  ...
  },
  {
    ...
    hasMarket: false,
    initialDiscovery: 'rumored',
    discoversFaction: 'BEASTFOLK',
    discoveryEventId: 'beastfolk_first_encounter',
  ...
  },
  {
    ...
    initialDiscovery: 'rumored',
    discoversFaction: 'BEASTFOLK',
    discoveryEventId: 'goblin_first_encounter',
  ...
  {
    id: 'harpy_eyrie',
    name: 'The Windward Crags',
    blurb:
      'A stormwracked shelf of the high Stormwall where the wind never stops and the harpies nest above the treeline. No path leads up that a laden mule could climb, and no aerie speaks for the rest. Deliberately not a diplomacy seat — the crags answer to no one you could treat with. Found only by those who push deep past the pass.',
    hasMarket: false,
    initialDiscovery: 'unknown',
    discoversFaction: 'HARPY',
    discoveryEventId: 'harpy_first_encounter',
    tags: ['wilds', 'harpy', 'danger'],
    mapPoint: { x: 0.21, y: 0.08 },
    mapRegion: 'stormwall',
  },
  {
    id: 'drowned_ruins',

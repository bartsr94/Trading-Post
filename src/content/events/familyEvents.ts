    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          outcome.history('Wed into the Tributary Towns, sealing the river alliance.'),
        ],
      },
      {
        type: 'flat',
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          outcome.history('Kept a hearth-companion of the river folk.'),
        ],
      },
      {
        type: 'flat',
    ...
    choices: [
      {
        ...
        outcomes: [{ type: 'pickPartner' }, outcome.continueChain('family_party_spark_ask')],
      },
      {
        type: 'flat',
    ...
    choices: [
      {
        ...
        critSuccess: {
          ...
          outcomes: [{ type: 'formHeroUnion' }, { type: 'addTrait', trait: 'wed_party' }, outcome.history('Wed {partner}, another of the company\'s own.')],
        },
        success: {
        ...
        critFailure: {
          ...
          outcomes: [outcome.stress(2), outcome.history('Asked {partner} to be wed, and was refused.')],
        },
      },
      {
        type: 'flat',
    ...
    choices: [
      {
        ...
        outcomes: [{ type: 'addDependant', kind: 'child' }, { type: 'axis', axis: 'communal', delta: 1 }, outcome.history('A child was born into the household.')],
      },
    ],
  }),

        ...
        outcomes: {
          ...
          critFailure: {
            ...
            outcomes: [
              ...
              { type: 'history', text: 'Cornered a band of goblins at the wall and was carried off for it.' },
            ],
          },
        },
      },
      {
        ...
        outcomes: {
          ...
          critFailure: {
            ...
            outcomes: [
              { type: 'captureHero', faction: 'BEASTFOLK' },
              { type: 'history', text: 'Tried to scare off a band of goblins at the wall and was carried off for it.' },
            ],
          },
        },
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              { type: 'history', text: 'Left a band of watching goblins alone at the wall.' },
            ],
          },
        },
      },
    ...
    choices: [
      {
        ...
        outcomes: {
          ...
          critFailure: {
            ...
            outcomes: [{ type: 'history', text: 'A goblin house-inspection ended badly and went nowhere further.' }],
          },
        },
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              { type: 'history', text: 'Let a band of goblins keep looking the place over, unpressed.' },
              { type: 'queueEvent', eventId: 'goblin_match_intrusion', delayTurns: 3, sameHero: true },
            ],
          },
        },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              { type: 'history', text: 'Threw a band of goblins out of the house for good.' },
            ],
          },
        },
      },
        ...
        outcomes: {
          critSuccess: {
            ...
            outcomes: [
              ...
              { type: 'history', text: 'Took in an entire goblin band as wives, all at once, on their own insistence.' },
            ],
          },
          success: {
          ...
          failure: {
            ...
            outcomes: [
              ...
              { type: 'standing', faction: 'BEASTFOLK', delta: 2 },
              { type: 'addTrait', trait: 'wed_goblin' },
              { type: 'history', text: 'A goblin band\'s mass marriage proposal only partly held together.' },
            ],
          },
          critFailure: {
            ...
            outcomes: [
              ...
              { type: 'stress', delta: 1 },
              { type: 'history', text: 'A goblin band\'s mass marriage proposal collapsed loudly, but they settled at the post anyway.' },
            ],
          },
        },
      },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              { type: 'history', text: 'A goblin band that came asking after a wedding settled at the post as residents instead.' },
            ],
          },
        },
      },

    ...
    choices: [
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [{ type: 'continueChain', eventId: 'goblin_first_encounter_jest' }],
          },
        },
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [{ type: 'continueChain', eventId: 'goblin_first_encounter_scold' }],
          },
        },
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [{ type: 'continueChain', eventId: 'goblin_first_encounter_trade' }],
          },
        },
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              { type: 'history', text: 'Walked past a goblin scheme in progress without getting involved.' },
            ],
          },
        },
      },
        ...
        outcomes: {
          critSuccess: {
            ...
            outcomes: [
              ...
              { type: 'history', text: 'Took a goblin prank in good humor and won their delighted approval.' },
            ],
          },
          success: {
        ...
        outcomes: {
          critSuccess: {
            ...
            outcomes: [
              ...
              { type: 'history', text: 'Scattered a goblin scheme with a single well-aimed order.' },
            ],
          },
          success: {
      ...
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [{ type: 'history', text: 'Left a goblin scheme to sort itself out.' }],
          },
        },
      },
    ],
    ...
    choices: [
      {
        ...
        outcomes: {
          critSuccess: {
            ...
            outcomes: [
              { type: 'standing', faction: 'BEASTFOLK', delta: 3 },
              { type: 'history', text: 'Talked a goblin committee out of their entire prank rig.' },
            ],
          },
          success: {
          ...
          failure: {
            ...
            outcomes: [{ type: 'good', good: 'tools', delta: -4 }],
          },
          critFailure: {
      ...
      },
      {
        ...
        outcomes: {
          success: {
            ...
            outcomes: [{ type: 'history', text: 'Declined to haggle with a goblin committee over their prank rig.' }],
          },
        },
      },
    ],

    ...
    choices: [
      {
        ...
        failure: {
          ...
          outcomes: [outcome.stress(fc.peaceFailureStress)],
        },
        critFailure: {
      ...
      },
      {
        ...
        failure: {
          ...
          outcomes: [
            ...
            outcome.health(-fc.hostileFailureHealth),
            outcome.stress(fc.hostileFailureStress),
          ],
        },
        critFailure: {
          ...
          outcomes: [
            ...
            outcome.health(-fc.hostileCritFailureHealth),
            outcome.stress(fc.hostileCritFailureStress),
          ],
        },
      },
      {

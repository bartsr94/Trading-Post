        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              {
                type: 'history',
                text: 'Backed away from an orc patrol at the treeline rather than risk a first meeting.',
              },
            ],
          },
        },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              {
                type: 'history',
                text: 'Struck a lasting understanding with an orc patrol at the treeline.',
              },
            ],
          },
        },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              {
                type: 'history',
                text: 'Won a wary respect from an orc patrol without striking a bargain.',
              },
            ],
          },
        },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              {
                type: 'history',
                text: 'Left an orc patrol with a grudge after a tense first meeting.',
              },
            ],
          },
        },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              { type: 'standing', faction: 'BEASTFOLK', delta: 2 },
              { type: 'history', text: 'Traded a token gift with an orc patrol at first meeting.' },
            ],
          },
        },
      },
        ...
        outcomes: {
          success: {
            ...
            outcomes: [
              ...
              {
                type: 'history',
                text: 'A first encounter with an orc patrol ended without further word either way.',
              },
            ],
          },
        },

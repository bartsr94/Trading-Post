  ...
  makeChoiceEvent({
    ...
    choices: [
      ...
      },
      {
        ...
        outcomes: [outcome.history('Noticed an orc woman watching from the treeline and let the moment pass unanswered.')],
      },
    ],
  }),
  makeChoiceEvent({
    ...
    choices: [
      {
        ...
        critSuccess: {
          ...
          outcomes: [
            ...
            outcome.history('Wed an orc woman who chose the post over her own kind\'s odds, as his {spouseRank}.'),
          ],
        },
        success: {
        ...
        failure: {
          ...
          outcomes: [
            ...
            outcome.history('An orc woman who came to test a hero\'s worth settled at the post instead, unmarried.'),
          ],
        },
        critFailure: {
      ...
      },
      {
        ...
        outcomes: [
          ...
          outcome.history('An orc woman who came watching a hero chose to settle at the post as a resident.'),
        ],
      },
    ],
  }),

    ...
    choices: [
      {
        ...
        outcomes: [
          outcome.silver(-20),
          outcome.good('grain', -6),
          outcome.standing('BEASTFOLK', 3),
          outcome.history('Bought off a gathering war-band before it could strike.'),
        ],
      },
      {
        type: 'flat',
        ...
        outcomes: [outcome.history('Stood ready against a gathering war-band.')],
      },
      {
        type: 'checked',
        ...
        critSuccess: {
          ...
          outcomes: [
            ...
            outcome.history('Faced down a war-band with nothing but nerve and a well-drilled guard.'),
          ],
        },
        success: {
          text: 'The message lands, but so does the insult. They do not come today — but they are coming.',
          outcomes: [outcome.standing('BEASTFOLK', -4)],
        },
        failure: {
          ...
          outcomes: [outcome.standing('BEASTFOLK', -5), { type: 'startRaid', faction: 'BEASTFOLK' }],
        },
        critFailure: {
          text: 'The messenger does not come back. What comes instead, fast and furious and in force, is the war-band itself.',
          outcomes: [outcome.standing('BEASTFOLK', -6), { type: 'startRaid', faction: 'BEASTFOLK', severity: 'warband' }],
        },
      },
    ],
  }),
      ...
      },
      {
        ...
        success: {
          ...
          outcomes: [
            ...
            outcome.history('Rallied the post after a sacking, vowing it would not happen again.'),
          ],
        },
        failure: {

    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          outcome.history('The widows’ debt was paid at last.'),
        ],
      },
      {
        type: 'checked',
        ...
        failure: {
          ...
          outcomes: [outcome.stress(4), { type: 'addTrait', trait: 'shaken' }, outcome.standing('CHARTER_COMPANY', -4)],
        },
      },
    ],
  }),
    ...
    choices: [
      {
        ...
        success: {
          ...
          outcomes: [
            outcome.standing('CHARTER_COMPANY', 6),
            outcome.stress(-2),
            { type: 'removeTrait', trait: 'homesick' },
            outcome.history('His letters home became the first survey of the territory.'),
          ],
        },
        failure: {
    ...
    choices: [
      {
        ...
        success: {
          ...
          outcomes: [outcome.standing('HILL_TRIBES', 8), outcome.history('Cleared the poachers out of the fur grounds alone.')],
        },
        failure: {
          ...
          outcomes: [outcome.health(-2), outcome.standing('HILL_TRIBES', -4)],
        },
      },
      {
        type: 'flat',
        ...
        outcomes: [outcome.standing('HILL_TRIBES', 5), { type: 'axis', axis: 'integration', delta: 1 }, outcome.stress(1)],
      },
      {
        type: 'flat',
        ...
        outcomes: [outcome.good('furs', 5), outcome.silver(-10), outcome.setFlag('bought_poached_furs'), outcome.stress(2)],
      },
    ],
  }),
  makeChoiceEvent({
    ...
    choices: [
      {
        ...
        critSuccess: {
          ...
          outcomes: [outcome.silver(30), outcome.stress(-2)],
        },
        success: {
          ...
          outcomes: [outcome.silver(12), outcome.stress(-1)],
        },
        failure: {
          ...
          outcomes: [outcome.silver(-15), outcome.stress(2)],
        },
        critFailure: {
          ...
          outcomes: [outcome.silver(-20), outcome.health(-1), outcome.stress(3)],
        },
      },
      {
        type: 'flat',
    ...
    choices: [
      {
        ...
        outcomes: [outcome.stress(-6), { type: 'addTrait', trait: 'shaken' }, outcome.history('Broke under the frontier’s weight, and was given time to mend.')],
      },
      {
        type: 'checked',
        ...
        success: {
          ...
          outcomes: [outcome.stress(-4), outcome.history('Held together through the worst of it, because they were asked to.')],
        },
        failure: {
          ...
          outcomes: [{ type: 'heroDeparts' }, outcome.stress(2, true)],
        },
      },
    ],
  }),
    ...
    choices: [
      {
        ...
        outcomes: [outcome.silver(-25), outcome.stress(-3), outcome.history('An old debt was finally settled.')],
      },
      {
        type: 'checked',
    ...
    choices: [
      {
        ...
        success: {
          ...
          outcomes: [outcome.standing('CHARTER_COMPANY', 6), outcome.stress(-2), outcome.history('Turned homesick scribbling into the first survey of the territory.')],
        },
        failure: {
    ...
    choices: [
      {
        ...
        success: {
          ...
          outcomes: [outcome.standing('HILL_TRIBES', 8), outcome.history('Cleared the poachers out of the Tribes\' hunting grounds.')],
        },
        failure: {

...
export const RECRUITS: RecruitDef[] = [
  ...
  },
  {
    ...
    portraitKey: 'dustwalker_male_01',
    heritage: 'dustwalker',
    gender: 'male',
    bio: 'A Hanjoda horseman who rode escort for a caravan that never paid him. He keeps the horse and the grudge, and hires his spear to those who settle their debts.',
  ...
  },
  {
    ...
    portraitKey: 'bejasi_female_02',
    heritage: 'bejasi',
    gender: 'female',
    bio: 'She speaks for the Old People to outsiders, a rare and dangerous office. Whether she came to your post to bridge the two worlds or to watch you for her elders, she has not said.',
